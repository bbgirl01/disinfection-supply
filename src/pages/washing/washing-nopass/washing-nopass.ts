...
/**
 * Generated class for the WashingNopassPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-washing-nopass',
  templateUrl: 'washing-nopass.html',
})
export class WashingNopassPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad WashingNopassPage');
  }
