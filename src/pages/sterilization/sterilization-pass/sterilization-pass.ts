...
/**
 * Generated class for the SterilizationPassPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-sterilization-pass',
  templateUrl: 'sterilization-pass.html',
})
export class SterilizationPassPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SterilizationPassPage');
  }
